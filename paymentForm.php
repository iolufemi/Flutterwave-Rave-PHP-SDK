...
<html>
    <body>
        <form method="POST" action="https://ravesandboxapi.flutterwave.com/processPayment.php" id="paymentForm">
            ...
            <input type="hidden" name="publicKey" value="FLWPUBK-#####YOUR_PUBLIC_KEY#####-X"> <!-- Put your public key here -->
